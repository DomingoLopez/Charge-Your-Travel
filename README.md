...
Este proyecto cubre los siguientes aspectos clave a tener en cuenta:

* Multi usuario
* Distintos perfiles de usuario (particulares, estaciones de servicio...)
* Lógica de negocio adicional: Sistema de recomendación óptima de rutas, puntos y descuentos en estaciones de servicio.


## Documentación Hítos

* [Documentación hito 0](doc/hitos/0/configuracion-entorno.md)
